...
namespace chromium_rust_perf {
#ifndef CXXBRIDGE1_STRUCT_chromium_rust_perf$MojoValidateResultCxx
#define CXXBRIDGE1_STRUCT_chromium_rust_perf$MojoValidateResultCxx
struct MojoValidateResultCxx final {
  ::std::uint32_t status CXX_DEFAULT_VALUE(0);
  ::std::uint32_t error_offset CXX_DEFAULT_VALUE(0);
