...
REPORTS = [
    ...
    },
    {
        "name": "progress",
        "order": 2,
        "json": "target/reports/progress_report.json",
        "markdown": "target/reports/progress_report.md",
        "purpose": "Human-readable standalone and overall Chromium migration percentage estimates.",
    },
    {
