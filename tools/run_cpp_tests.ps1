...
Write-Host "================================================================"
Write-Host "           Compiling C++ Test Program                           "
Write-Host "================================================================"

$outputExe = "cpp_test/main.exe"
...
Write-Host "C++ test compiled successfully: $outputExe"
Write-Host ""

Write-Host "================================================================"
Write-Host "           Running C++ Differential Tests                       "
Write-Host "================================================================"
& $outputExe
...
Write-Host ""
if ($exitCode -eq 0) {
    Write-Host "SUCCESS: All C++ differential tests passed!" -ForegroundColor Green
} else {
    Write-Error "FAILURE: Some C++ tests failed. Exit code: $exitCode"
}
