...
Write-Host "================================================================"
Write-Host "           Validating P0 Fuzz Corpus Manifest                   "
Write-Host "================================================================"
Invoke-NativeChecked { python tools/check_fuzz_corpus_manifest.py }
Invoke-NativeChecked { python tools/emit_fuzz_corpus_replay.py }
...
Write-Host "================================================================"
Write-Host "           Compiling P0 Fuzz Corpus Replay Harness              "
Write-Host "================================================================"

$outputExe = "target/fuzz_corpus_replay/main.exe"
...
if ($compiler -eq "clang++") {
    $compileCmd = @(
        ...
        "-std=c++17",
        "-I.",
        "target/fuzz_corpus_replay/main.cc",
...
Write-Host "C++ corpus replay harness compiled successfully: $outputExe"
Write-Host ""

Write-Host "================================================================"
Write-Host "           Running P0 Fuzz Corpus Replay                        "
Write-Host "================================================================"
& $outputExe
...
Write-Host ""
if ($exitCode -eq 0) {
    Write-Host "SUCCESS: P0 fuzz corpus replay passed." -ForegroundColor Green
} else {
    Write-Error "FAILURE: P0 fuzz corpus replay failed. Exit code: $exitCode"
}
